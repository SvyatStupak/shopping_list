...
<script type="text/javascript">
    ...
    */
    ...
    {
        let url = $('meta[name=app-url]').attr("content") + "index.php/project/show_all";
        $.ajax({
            url: url,
            type: "GET",
    ...
    */
    ...
    {   
        ...
        let url = $('meta[name=app-url]').attr("content") + "index.php/project/store";
        let data = {
            name: $("#name").val(),
    ...
    */
    ...
    {
        let url = $('meta[name=app-url]').attr("content") + "index.php/project/edit/" + id ;
        $.ajax({
            url: url,
            type: "GET",
            success: function(response) {
    ...
    */
    ...
    {
        $("#save-project-btn").prop('disabled', true);
        let url = $('meta[name=app-url]').attr("content") + "index.php/project/update/" + $("#update_id").val();
        let data = {
            id: $("#update_id").val(),
            name: $("#name").val(),
            description: $("#description").val(),
    ...
    */
    function showProject(id)
    {
        ...
        let url = $('meta[name=app-url]').attr("content") + "index.php/project/show/" + id +"";
        $.ajax({
            url: url,
            type: "GET",
            success: function(response) {
    ...
    */
    ...
    {
        let url = $('meta[name=app-url]').attr("content") + "index.php/project/delete/" + id;
        let data = {
            name: $("#name").val(),
            description: $("#description").val(),
        };
